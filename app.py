...
def index():
    ...
    # CSS와 JS 링크 인라인으로 변경
    html_content = html_content.replace('{{ url_for(\'static\', filename=\'styles.css\') }}', '/styles.css')
    html_content = html_content.replace('{{ url_for(\'static\', filename=\'script.js\') }}', '/script.js')
